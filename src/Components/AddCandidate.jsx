...
export const AddCandidate = () => {
  ...
  return (
    <div className='@container w-[90%] sm:w-[70%] md:w-[45%] mx-auto my-10 border-2 rounded border-sky-300 bg-white'>
      ...
      <form action="" className='p-5' method='post' onSubmit={AddCandidate}>
        ...
        <div className='grid grid-flow-col justify-items-center mt-5 px-auto'>
          <button type='submit' className='text-xl bg-blue-700 rounded-md text-white w-[40%] px-5 py-2'>Add</button>
        </div>
      </form>
    </div>
  )
