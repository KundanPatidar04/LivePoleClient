    ...
    return (
        <>
            <div className='@container w-4xl mx-auto my-10 border-2 rounded border-sky-300 bg-white'>
                ...
                <form action="" className='p-5 flex flex-wrap' onSubmit={createElection}>
                    ...
                    <div className='w-1/2 p-2 grid font-bold'>
                    ...
                    <div className='grid grid-flow-col w-full justify-items-center mt-5 px-10'>
                        <button type='submit' className='text-xl bg-blue-700 rounded-md text-white px-5 py-2'>Create</button>
                    </div>
                </form>
            </div>
        </>
